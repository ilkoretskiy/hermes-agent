...
def looks_like_codex_intermediate_ack(
    ...
    # The assistant must announce an ACTION (not just "I'll help you
    # brainstorm"). Match against the code/quote-stripped text so quoted
    # example dialogue and fenced snippets don't count (false-positive fix,
    # 2026-05-24 tutor-session repro).
